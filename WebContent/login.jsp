  ...
  <body>
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          <div><a class="navbar-brand" href="index.html" style="font-size:32px;">RBAC考试系统</a></div>
        </div>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <form id="loginForm" action="doLogin" method="post" class="form-signin" role="form">
        <h2 class="form-signin-heading"><img alt="icon" src="./images/icon.png" width="40px" heigth="40px"> 用户登录</h2><!-- <i class="glyphicon glyphicon-user"></i> -->
        ...
        <a class="btn btn-lg btn-primary btn-block" href="main.jsp" > 登录</a>
      </form>
    </div>
